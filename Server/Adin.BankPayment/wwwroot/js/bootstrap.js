 ...
 */
        ...
        var Util = function($$$1) {
            ...
            function escapeId(selector) {
                ...
                selector = typeof $$$1.escapeSelector === "function"
            ...
            var Alert =
                ...
                function() {
                    ...
                    _proto._removeElement = function _removeElement(element) {
                        ...
                        $$$1(element).one(Util.TRANSITION_END,
                            function(event) {
 ...
 */
        ...
        var Button = function($$$1) {
            ...
            $$$1(document).on(Event.CLICK_DATA_API,
            ...
            var Carousel =
                ...
                function() {
                    ...
                    _proto.to = function to(index) {
                        ...
                        if (this._isSliding) {
                            $$$1(this._element).one(Event.SLID,
                                function() {
                    ...
                    _proto._addEventListeners = function _addEventListeners() {
                        ...
                        if (this._config.keyboard) {
                            $$$1(this._element).on(Event.KEYDOWN,
                                function(event) {
                        ...
                        if (this._config.pause === "hover") {
                            $$$1(this._element).on(Event.MOUSEENTER,
                                function(event) {
                    ...
                    _proto._slide = function _slide(direction, element) {
                        ...
                        if (Util.supportsTransitionEnd() && $$$1(this._element).hasClass(ClassName.SLIDE)) {
                            ...
                            $$$1(activeElement).one(Util.TRANSITION_END,
                                function() {
                                    $$$1(nextElement).removeClass(directionalClassName + " " + orderClassName)
            ...
            var Collapse =
                ...
                function() {
                    function Collapse(element, config) {
                        ...
                        this._element = element;
                        this._config = this._getConfig(config);
                        this._triggerArray = $$$1.makeArray($$$1("[data-toggle=\"collapse\"][href=\"#" +
                            element.id +
                            "\"]," +
                    ...
                    _proto.show = function show() {
                        ...
                        var complete = function complete() {
                            $$$1(_this._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE)
                        ...
                        $$$1(this._element).one(Util.TRANSITION_END, complete)
                            .emulateTransitionEnd(TRANSITION_DURATION);
                    ...
                    _proto.hide = function hide() {
                        ...
                        $$$1(this._element).addClass(ClassName.COLLAPSING).removeClass(ClassName.COLLAPSE)
                        ...
                        var complete = function complete() {
                            ...
                            $$$1(_this2._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE)
                    ...
                    _proto._addAriaAndCollapsedClass = function _addAriaAndCollapsedClass(element, triggerArray) {
                        if (element) {
                            ...
                            if (triggerArray.length > 0) {
                                $$$1(triggerArray).toggleClass(ClassName.COLLAPSED, !isOpen)
 ...
 */
        ...
        var Dropdown = function($$$1) {
            ...
            var AttachmentMap = (_AttachmentMap = {}, _AttachmentMap[RTL ? "TOPEND" : "TOP"] =
                "top-start", _AttachmentMap[RTL ? "TOP" : "TOPEND"] =
                "top-end", _AttachmentMap[RTL ? "BOTTOMEND" : "BOTTOM"] =
                "bottom-start", _AttachmentMap[RTL ? "BOTTOM" : "BOTTOMEND"] =
                "bottom-end", _AttachmentMap[RTL ? "LEFT" : "RIGHT"] =
                "right-start", _AttachmentMap[RTL ? "LEFTEND" : "RIGHTEND"] =
                "right-end", _AttachmentMap[RTL ? "RIGHT" : "LEFT"] =
                "left-start", _AttachmentMap[RTL ? "RIGHTEND" : "LEFTEND"] = "left-end", _AttachmentMap);
            var Default = {
                offset: 0,
                flip: true,
                ...
                function() {
                    ...
                    _proto.toggle = function toggle() {
                        ...
                        if (!this._inNavbar) {
                            ...
                            var element =
                                this._element; // For dropup with alignment we use the parent as popper container

                            if ($$$1(parent).hasClass(ClassName.DROPUP)) {
                                if ($$$1(this._menu).hasClass(ClassName.MENULEFT) ||
                    ...
                    _proto._addEventListeners = function _addEventListeners() {
                        ...
                        $$$1(this._element).on(Event.CLICK,
                            function(event) {
                                event.preventDefault();
            ...
            $$$1(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Dropdown._dataApiKeydownHandler)
                .on(Event.KEYDOWN_DATA_API, Selector.MENU, Dropdown._dataApiKeydownHandler)
                .on(Event.CLICK_DATA_API + " " + Event.KEYUP_DATA_API, Dropdown._clearMenus).on(Event.CLICK_DATA_API,
                    Selector.DATA_TOGGLE,
                    function(event) {
                        event.preventDefault();
                        event.stopPropagation();
        ...
        var Modal = function($$$1) {
            ...
            var Modal =
                ...
                function() {
                    ...
                    _proto.show = function show(relatedTarget) {
                        ...
                        $$$1(this._element).on(Event.CLICK_DISMISS,
                        ...
                        $$$1(this._dialog).on(Event.MOUSEDOWN_DISMISS,
                            function() {
                                $$$1(_this._element).one(Event.MOUSEUP_DISMISS,
                                    function(event) {
                    ...
                    _proto._showElement = function _showElement(relatedTarget) {
                        ...
                        if (transition) {
                            $$$1(this._dialog).one(Util.TRANSITION_END, transitionComplete)
                                .emulateTransitionEnd(TRANSITION_DURATION);
                        } else {
                            transitionComplete();
                        }
                    ...
                    _proto._setEscapeEvent = function _setEscapeEvent() {
                        ...
                        if (this._isShown && this._config.keyboard) {
                            $$$1(this._element).on(Event.KEYDOWN_DISMISS,
                                function(event) {
                                    if (event.which === ESCAPE_KEYCODE) {
                                        event.preventDefault();
                    ...
                    _proto._showBackdrop = function _showBackdrop(callback) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            $$$1(this._backdrop).one(Util.TRANSITION_END, callback)
                            ...
                            if (Util.supportsTransitionEnd() && $$$1(this._element).hasClass(ClassName.FADE)) {
                                $$$1(this._backdrop).one(Util.TRANSITION_END, callbackRemove)
                                    .emulateTransitionEnd(BACKDROP_TRANSITION_DURATION);
                            } else {
                                callbackRemove();
                            }
                    ...
                    _proto._setScrollbar = function _setScrollbar() {
                        ...
                        if (this._isBodyOverflowing) {
                            ...
                            $$$1(Selector.FIXED_CONTENT).each(function(index, element) {
                                ...
                                $$$1(element).data("padding-right", actualPadding).css("padding-right",
                            ...
                            $$$1(Selector.STICKY_CONTENT).each(function(index, element) {
                                ...
                                $$$1(element).data("margin-right", actualMargin).css("margin-right",
                            ...
                            $$$1("body").data("padding-right", actualPadding).css("padding-right",
            ...
            $$$1(document).on(Event.CLICK_DATA_API,
                ...
                function(event) {
                    ...
                    var $target = $$$1(target).one(Event.SHOW,
                        function(showEvent) {
                            if (showEvent.isDefaultPrevented()) {
 ...
 */
        ...
        var Tooltip = function($$$1) {
            ...
            var AttachmentMap = (_AttachmentMap = {
                AUTO: "auto",
                TOP: "top"
            }, _AttachmentMap[RTL ? "LEFT" : "RIGHT"] = "right", _AttachmentMap.BOTTOM =
                "bottom", _AttachmentMap[RTL ? "RIGHT" : "LEFT"] = "left", _AttachmentMap);
            var Default = {
                animation: true,
                ...
                function() {
                    ...
                    _proto.show = function show() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            var container = this.config.container === false
                                ? document.body
                            ...
                            this._popper = new Popper(this.element,
                                tip,
                                {
                            ...
                            if (Util.supportsTransitionEnd() && $$$1(this.tip).hasClass(ClassName.FADE)) {
                                $$$1(this.tip).one(Util.TRANSITION_END, complete)
                    ...
                    _proto._setListeners = function _setListeners() {
                        ...
                        triggers.forEach(function(trigger) {
                            if (trigger === "click") {
                                $$$1(_this3.element).on(_this3.constructor.Event.CLICK,
                            ...
                            $$$1(_this3.element).closest(".modal").on("hide.bs.modal",
                                function() {
                                    return _this3.hide();
                                });
                        });
            ...
            var ScrollSpy =
                ...
                function() {
                    function ScrollSpy(element, config) {
                        ...
                        $$$1(this._scrollElement).on(Event.SCROLL,
                            function(event) {
